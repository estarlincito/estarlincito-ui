...
import { keyframes as h, css as u$1, styled as j, setup as m } from '../../../../goober@2.1.16_csstype@3.1.3/node_modules/goober/dist/goober.modern.mjs';
...
`,Ae=(e,t)=>{let s=e.includes("top")?1:-1,[a,o]=A()?[he,xe]:[ye(s),ge(s)];return {animation:t?`${h(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${h(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}};React.memo(({toast:e,position:t,style:r,children:s})=>{let a=e.height?Ae(e.position||t||"top-center",e.visible):{opacity:0},o=React.createElement(M,{toast:e}),n=React.createElement(Se,{...e.ariaProps},f(e.message,e));return React.createElement(be,{className:e.className,style:{...a,...r,...e.style}},typeof s=="function"?s({icon:o,message:n}):React.createElement(React.Fragment,null,o,n))});m(React.createElement);u$1`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
...
export { _ as CheckmarkIcon, k as ErrorIcon, V as LoaderIcon, M as ToastIcon, f as resolveValue, c as toast };
